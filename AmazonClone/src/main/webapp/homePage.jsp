...
<body>
	<div class="sidebar">
		<div class="hdn-head">
			<h2>
				<a class="mss" href="#">Hello,<%=session.getAttribute("userName")%></a>
			</h2>
		...
		<div class="hdn-table">
			...
			<div>
				...
				<ul>
					...
					<li><a href="404.html">Recommendations</a></li>
					<li><a href="404.html">Browsing History</a></li>
					<li><a href="404.html">Watchlist</a></li>
					<li><a href="404.html">Video Purchase</a></li>
					<li><a href="404.html">Kindle Unlimited</a></li>
		...
		<div class="first">
			...
			<div class="flex right">
				...
				<div class="sign">
					...
					<div class="flex ac">
						<span>Accounts & Lists</span> <i class="fas fa-caret-down"></i>
					</div>
				</div>
				<div class="sign">
				...
				<div class="flex cart">
					...
					<form action="CartServlet" method="GET">
						...
						<button type="submit" class="ca">Cart</button>
					</form>
			...
			<div class="container-1">
				...
				<div class="product-comp">
					<div class="box">
						...
						<a href="products.jsp?name=${userName}&id=${id}">See More</a>
	...
	<section class="sec-2">
		...
		<div class="slide-sec">
			<div class="l-btn btn-1b">
				<i class="fa-solid fa-chevron-left"></i>
			</div>
			<div class="r-btn btn-1a">
				<i class="fa-solid fa-chevron-right"></i>
			</div>
	...
	<div class="product-comp">
		...
		<div class="box box-d">
			...
			<div class="box-a">
				<div>
					<img src="images/cm1.jpg" alt=""> <span>Sweatshirts</span>
				</div>
				<div>
					<img src="images/cm2.jpg" alt=""> <span>Joggers</span>
				</div>
				<div>
					<img src="images/cm3.jpg" alt=""> <span>Cardigans</span>
				</div>
				<div>
					<img src="images/cm4.jpg" alt=""> <span>Easy Tees</span>
				</div>
			</div>
			<a href="products.jsp?name=${userName}&id=${id}">See More</a>
		</div>
		<div class="box box-d">
			...
			<div class="box-a">
				<div>
					<img src="images/gm1.jpg" alt=""> <span>Apparel</span>
				</div>
				<div>
					<img src="images/gm2.jpg" alt=""> <span>Hats</span>
				</div>
				<div>
					<img src="images/gm3.jpg" alt=""> <span>Action Figures</span>
				</div>
				<div>
					<img src="images/gm4.jpg" alt=""> <span>Mugs</span>
				</div>
			</div>
			<a href="products.jsp?name=${userName}&id=${id}">See More</a>
		</div>
	...
	<section class="sec-2">
		<!-- <h3>Popular Products in Wirelessly Internationally</h3> -->
		<div class="slide-sec">
			<div class="l-btn btn-1c">
				<i class="fa-solid fa-chevron-left"></i>
			</div>
			<div class="r-btn btn-1d">
				<i class="fa-solid fa-chevron-right"></i>
			</div>
	...
	<section class="footer">
		...
		<div class="line"></div>
		<div class="copy">
			<span>&copy; Designed By Suresh Bundhe</span>
		</div>
